module Bitmovin::Encoding::Manifests
  class VideoAdaptationSet < Bitmovin::Resource
    ...
    child_collection(:webm_representations, "/v1/encoding/manifests/dash/%s/periods/%s/adaptationsets/%s/representations/webm", [:manifest_id, :period_id, :id], WebmRepresentation)
